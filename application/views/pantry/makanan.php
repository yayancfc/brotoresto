...
<div id="content">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-3 fitur">
                            <div class="button-group">
                                <a href="<?= base_url('Pantry/detailmakanan?id_menu='.$value->id_menu) ?>"><button type="button" class="lihat">Lihat</button></a>
        ...
        <div class="modal fade" id="tambahModal" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                  <form action="<?= base_url() ?>Pantry/tambahmakanan" method="post" enctype="multipart/form-data" id="uploadimage">
        ...
        <div class="modal fade" id="ubahModal" role="dialog">
            <div class="modal-dialog">
                ...
                <!-- Modal content-->
                <div class="modal-content">
                  <form action="<?= base_url() ?>Pantry/updatemakanan" method="post" enctype="multipart/form-data" >
                    <div class="modal-header">
                        <div class="col-md-10 col-sm-10 col-xs-10">
        ...
        <script src="<?php echo base_url('assets/js/makanan.js') ?>" type="text/javascript"></script>
